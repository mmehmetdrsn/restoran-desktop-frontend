...
import { 
  ...
  FaPhone, FaHome, FaBell, FaEnvelope, 
  FaHistory, FaEye, FaTimes, FaUser
} from 'react-icons/fa';
...
const KuryePanel = () => {
  ...
  const [activeOrders, setActiveOrders] = useState([
    ...
    { 
      ...
      address: 'Papatya Mah. No:56', 
      amount: 530, 
      status: 'Teslim Ediliyor', 
      time: '7 dk',
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex gap-2 flex-wrap">
              <button 
                ...
                className="flex-1 px-4 py-3 bg-green-500/20 hover:bg-green-500/30 text-green-400 rounded-lg flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
                <FaPhone /> Müşteriyi Ara
              </button>
              <button 
                onClick={() => handleDeliveryConfirm(order)} 
                className="flex-1 px-4 py-3 bg-yellow-500/20 hover:bg-yellow-500/30 text-yellow-400 rounded-lg flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
          ...
          <div key={order.id} className="flex items-center justify-between p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all">
            ...
            <div className="flex gap-2 flex-wrap">
              <button 
                ...
                className="px-3 py-1.5 bg-green-500/20 hover:bg-green-500/30 rounded-lg text-sm text-green-400 transition-all cursor-pointer z-10 relative"
              >
                <FaPhone />
              </button>
              <button 
                onClick={(e) => {
                  e.stopPropagation();
                  handleDeliveryConfirm(order);
                }} 
                className="px-3 py-1.5 bg-yellow-500/20 hover:bg-yellow-500/30 rounded-lg text-sm text-yellow-400 transition-all cursor-pointer z-10 relative"
              >
                <FaCheckCircle />
              </button>
              <button 
                ...
                className="px-3 py-1.5 bg-white/5 hover:bg-white/10 rounded-lg text-sm text-gray-300 transition-all cursor-pointer z-10 relative"
              >
                <FaEye />
              </button>
            </div>
  ...
  const HistoryContent = () => (
    <div className="bg-black/80 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
      ...
      <p className="text-gray-400 mb-4">Son 7 gün içinde tamamlanan siparişler:</p>
