  ...
  return (
    <div>
      ...
      <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
        <button onClick={onNewOrderClick} className="bg-black/60 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-black/80 transition-all text-center">
          <div className="text-white text-2xl mx-auto mb-2">+</div>
          <span className="text-white text-sm">Yeni Sipariş</span>
        </button>
        <button onClick={onOpenPaymentClick} className="bg-black/60 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-black/80 transition-all text-center">
          <div className="text-white text-2xl mx-auto mb-2">₺</div>
          <span className="text-white text-sm">Ödeme Al</span>
        </button>
        <button onClick={onOpenMoveTableClick} className="bg-black/60 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-black/80 transition-all text-center">
          <div className="text-white text-2xl mx-auto mb-2">→</div>
          <span className="text-white text-sm">Masa Taşı</span>
        </button>
        <button onClick={onOpenRefundClick} className="bg-black/60 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-black/80 transition-all text-center">
          <div className="text-white text-2xl mx-auto mb-2">↶</div>
