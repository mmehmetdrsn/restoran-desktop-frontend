...
import { FaUtensils, FaPlus, FaTrash, FaEdit, FaList, FaClipboardList } from 'react-icons/fa';
  ...
  return (
    <div className="bg-black/90 backdrop-blur-sm rounded-2xl p-6 border border-white/10 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <Buton icon={<FaClipboardList />} label="Recete Ekle" onClick={() => setShowReceteEkle(true)} />
      </div>
    </div>
  );
};
